...
@Component({
  selector: 'app-aprobacion-nodirecta',
  templateUrl: './aprobacion-nodirecta.component.html',
  styleUrls: ['./aprobacion-nodirecta.component.css']
})
export class AprobacionNODirectaComponent implements OnInit {
